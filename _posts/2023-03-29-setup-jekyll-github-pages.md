...
- site
date: 2023-03-27
image: /assets/images/2023-03-29-setup-jekyll-github-pages.png
layout: post
tags:
- categories
- AI
...
Save this as a Markdown file with a filename in the format yyyy-mm-dd-setting-up-a-site-hosted-with-github-pages.md, and place it in your Jekyll _posts directory. Then, when you build your Jekyll site, this post will be included and published as a blog post on your site.If you want to set up a site hosted with GitHub Pages using Jekyll and Git, here are the steps you should follow:
